        ...
        <div class="container">
            <div class="contain" id="content-solo">
                ...
                <div class="item">
                    ...
                    <?php
                    $total = 0;
                    foreach ($dataSolo['tugas'] as $task) {
                    ...
                    <div class="list" onclick="window.location.href='Group/detail'">
                        ...
                        <div class="bottom-group">
                            ...
                            <div class="progress-member">
                                ...
                                <div class="member">
                                    <img src="http://localhost/ourtaskmvc/public/image/Profil.png" alt=""
                                        class="ellipse">
                                    <img src="http://localhost/ourtaskmvc/public/image/Profil.png" alt=""
                                        class="ellipse">
                                    <img src="http://localhost/ourtaskmvc/public/image/Profil.png" alt=""
    ...
    <div id="overlay" class="">
            ...
            <div class="container">
                <div class="nav-button-list">
                    ...
                    <button class="navigation"
                        onclick="window.location.href='http://localhost/ourtaskmvc/public/home/calender'">
                        <div class="left-content">
                    ...
                    <button class="navigation" onclick="pathFind('complatedtask')">
                        <div class="left-content">
                    ...
                    <button class="navigation" onclick="window.location.href='admin/index.html'">
                        <div class="left-content">
        ...
        <div class="option">
            <div class="container">
                <div class="nav-button-list">
                    <button class="navigation"
                        onclick="window.location.href='http://localhost/ourtaskmvc/public/home/notification'">
                        <div class="left-content">
                    ...
                    <button class="navigation"
                        onclick="window.location.href='http://localhost/ourtaskmvc/public/setting'">
                        <div class="left-content">
                    ...
                    <button class="navigation"
                        onclick="window.location.href='http://localhost/ourtaskmvc/public/login'">
                        <div class="left-content">
